...
<div class="flex flex-1 flex-col">
	...
	>
		<GameCategory games={data.data.yourGames} profiles={data.data.profiles} queries={data.yourGamesQueries} alwaysShowEmpty={true} emptyComponent={GameCardsNew} title="Your Games" />
		<GameCategory games={data.data.collaborationGames} profiles={data.data.profiles} queries={data.collaborationGamesQueries} emptyComponent={GameCardsEmpty} title="Your Collaborations" />
